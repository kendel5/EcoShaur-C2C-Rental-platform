...
<form class="form-horizontal"
      ...
      onsubmit="return memberCheck(this)" >
            ...
            <h4 class="mb-3 text-left"><strong>회원정보</strong></h4>
                ...
                <div class="form-group text-left">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="id" id="id" size="15" placeholder="${id }" value="${id }" readonly>
                ...
                <div class="form-group text-left font1">
                    <div class="input-group" id="name_check">
                        ...
                        <input type="text" class="form-control" name="mem_name" id="mem_name" size="15" placeholder="${mymem.mem_name }" value="${mymem.mem_name }" required>
                    </div>
                </div>
                ...
                <div class="form-group text-left font1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="email" id="email" size="15" placeholder="${mymem.email }" value="${mymem.email }">
                    </div>
                </div>
				...
				<div class="form-group text-left font1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="contact_number" id="contact_number" size="15" placeholder="${mymem.contact_number }" value="${mymem.contact_number }" >
                    </div>
                </div>
                ...
                <div class="form-group text-left font1">
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" name="zip" id="zip" size='7' placeholder="${mymem.zip }" value="${mymem.zip }" readonly>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="address" id="address" size='45' placeholder="${mymem.address }" value=${mymem.address } readonly>
                    	<span class="input-group-addon" style="min-width:100px;">나머지 주소</span>
                        <input type="text" class="form-control" name="address_r" id="address_r" size='45' placeholder="${mymem.address_r }" value=${mymem.address_r }>
                    </div>
                </div>
		...
		<tr>
        <td colspan="2">
			<input type="submit" class="btn btn-outline-success" value="회원정보 수정">
...
$("#sm").click(function() {
   var x = $("#uid").val();
	...
	<c:otherwise>
		<script>alert('권한이없습니다'); window.location.href = '../login.do';</script>
	</c:otherwise>
</c:choose>
